const Button = ({ children, className,bType = "button", type="base", height="100%", width="100%", highlight=false, rounded, buttonColor, onClick}) => {
	const types = {
	...
	return (
		<button type={bType} className={types[type]} style={{"height":height, "width":width, "backgroundColor":bgColor, "borderRadius":rounded}} onClick={onClick} >
			{children}
		</button>
	)
}
