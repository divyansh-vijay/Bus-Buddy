const Navbar = () => {
	return (
		<div className="h-[8%] w-full bg-white rounded-[2px] border-b-[2px] border-gray-200 flex items-center justify-between gap-[15px] py-2">
			<div className="flex flex-row mx-2">
				...
				<h1 className="text-black  text-[15px] md:text-[20px] font-bold tracking-tight">
					Bus Buddy
				</h1>
			</div>
